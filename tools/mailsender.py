...
class MailSender:
    init_path = "./tools/config/init_email.yaml"  # 相对于__main__文件的路径
    ...
    def send(self, subject, content, attachments: [MIMEApplication] = None):
        ...
        self.smtp.sendmail(self.account, self.receivers, mm.as_string())
        print("邮件发送成功")
...
if __name__ == '__main__':
    ...
    mail_sender.send(_subject, html_maker.html_msg, [picture])
    mail_sender.quit()
